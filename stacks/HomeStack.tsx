...
export default function HomeStack() {
	...
	return (
		<Stack.Navigator {...navigationConfig(colorMode)}>
			...
			<Stack.Screen name={screens.READ_DOCUMENT.screenName} component={ReadDocument} options={({ route }) => ({
				title: route?.params?.data?.title || screens.READ_DOCUMENT.screenTitle,
				headerShown: true,
			})} />
		</Stack.Navigator>
	)
