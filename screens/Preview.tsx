...
import PreviewHeader, {PreviewNavigationHeader} from "../components/PreviewHeader";
...
export default function Preview({route, navigation}: ScreenProps) {
	...
	return (
	  <ScrollView px={0}
		  ...
		  <PreviewNavigationHeader data={data} onPress={toggleStar} onDelete={onDelete} navigation={navigation}/>
