		...
		<View flex={1} bg="dark.900">
			...
			>
				<View flex={1} alignItems="center" justifyContent="center">
					<Box w="full" h={height * 0.86} alignItems="center" justifyContent="space-between" py={4} px={6}>
						<VStack my={6} space={2}>
							<Icon as={Ionicons} name="md-lock-closed" size={10} color="muted.50" />
						...
						<Button
							...
							bg="light.200"
							alignItems="center"
							_text={{ color: "dark.900", fontWeight: "medium" }}
